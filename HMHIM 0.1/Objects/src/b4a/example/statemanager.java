...
{
final int step157 = 1;
final int limit157 = (int) (_th.getTabCount()-1);
...
{
final int step165 = 1;
final int limit165 = (int) (_tabparentpanel.getNumberOfViews()-1);
for (_i = (int) (0); (step165 > 0 && _i <= limit165) || (step165 < 0 && _i >= limit165); _i = ((int)(0 + _i + step165))) {
...
{
final int step179 = 1;
final int limit179 = (int) (_panel1.getNumberOfViews()-1);
...
{
final int step92 = 1;
final int limit92 = (int) (_th.getTabCount()-1);
...
{
final int step101 = 1;
final int limit101 = (int) (_tabparentpanel.getNumberOfViews()-1);
...
{
final int step114 = 1;
final int limit114 = (int) (_panel1.getNumberOfViews()-1);
...
{
final int step203 = 1;
final int limit203 = (int) (_activity.getNumberOfViews()-1);
for (_i = (int) (0); (step203 > 0 && _i <= limit203) || (step203 < 0 && _i >= limit203); _i = ((int)(0 + _i + step203))) {
