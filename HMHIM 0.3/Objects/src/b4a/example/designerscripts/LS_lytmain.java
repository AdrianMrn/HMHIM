...
//BA.debugLineNum = 16;BA.debugLine="lblWage.Height = 40dip"[lytmain/General script]
views.get("lblwage").setHeight((int)((40d * scale)));
...
//BA.debugLineNum = 18;BA.debugLine="lblWage.Top = 0%y"[lytmain/General script]
views.get("lblwage").setTop((int)((0d / 100 * height)));
...
//BA.debugLineNum = 28;BA.debugLine="lblMade.Top = 20%y"[lytmain/General script]
views.get("lblmade").setTop((int)((20d / 100 * height)));
...
//BA.debugLineNum = 40;BA.debugLine="lblStartPause.Width = 98%x"[lytmain/General script]
views.get("lblstartpause").setWidth((int)((98d / 100 * width)));
//BA.debugLineNum = 41;BA.debugLine="lblStartPause.Height = 45dip"[lytmain/General script]
views.get("lblstartpause").setHeight((int)((45d * scale)));
//BA.debugLineNum = 42;BA.debugLine="lblStartPause.top = lblTimepassed.Bottom + 5%y"[lytmain/General script]
views.get("lblstartpause").setTop((int)((views.get("lbltimepassed").getTop() + views.get("lbltimepassed").getHeight())+(5d / 100 * height)));
//BA.debugLineNum = 43;BA.debugLine="lblStartPause.Left = 2%x"[lytmain/General script]
...
//BA.debugLineNum = 50;BA.debugLine="lblStartPause.Width = 98%x"[lytmain/General script]
views.get("lblstartpause").setWidth((int)((98d / 100 * width)));
//BA.debugLineNum = 51;BA.debugLine="lblStartPause.Height = 45dip"[lytmain/General script]
views.get("lblstartpause").setHeight((int)((45d * scale)));
//BA.debugLineNum = 52;BA.debugLine="lblStartPause.Bottom = 100%y"[lytmain/General script]
views.get("lblstartpause").setTop((int)((100d / 100 * height) - (views.get("lblstartpause").getHeight())));
//BA.debugLineNum = 53;BA.debugLine="lblStartPause.Left = 2%x"[lytmain/General script]
views.get("lblstartpause").setLeft((int)((2d / 100 * width)));
//BA.debugLineNum = 55;BA.debugLine="btnReset.Width = 100dip"[lytmain/General script]
views.get("btnreset").setWidth((int)((100d * scale)));
//BA.debugLineNum = 56;BA.debugLine="btnReset.Height = 45dip"[lytmain/General script]
views.get("btnreset").setHeight((int)((45d * scale)));
//BA.debugLineNum = 57;BA.debugLine="btnReset.Right = 100%x"[lytmain/General script]
views.get("btnreset").setLeft((int)((100d / 100 * width) - (views.get("btnreset").getWidth())));
//BA.debugLineNum = 58;BA.debugLine="btnReset.Bottom = 100%y"[lytmain/General script]
