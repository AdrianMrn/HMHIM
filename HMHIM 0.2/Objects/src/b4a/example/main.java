...
public static String  _activity_create(boolean _firsttime) throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 218;BA.debugLine="ipdTip.InputType = 12290";
...
mostCurrent._listmancurr.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"$","€","£"}));
 //BA.debugLineNum = 223;BA.debugLine="listManExch.Initialize";
mostCurrent._listmanexch.Initialize();
 //BA.debugLineNum = 224;BA.debugLine="listManExch.AddAll(Array As String(\"1.36\", \"1\", \"0.79\"))";
...
if (_firsttime) { 
 //BA.debugLineNum = 227;BA.debugLine="CreatePreferenceScreen";
_createpreferencescreen();
 //BA.debugLineNum = 228;BA.debugLine="If PrefMan.GetAll.Size = 0 Then SetDefaults";
...
mostCurrent._listval.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new int[]{(int) (1940),(int) (2715),(int) (15140),(int) (6850),(int) (3000),(int) (50),(int) (6640),(int) (1660),(int) (2530),(int) (1580),(int) (8300),(int) (5140),(int) (70),(int) (9690),(int) (4720),(int) (3630),(int) (2790),(int) (4720),(int) (6420),(int) (4720),(int) (8660),(int) (5000),(int) (5330),(int) (5200),(int) (3630),(int) (2850),(int) (3510),(int) (190850),(int) (4240),(int) (100),(int) (2300),(int) (6660),(int) (6660),(int) (7020),(int) (6660),(int) (117000),(int) (190850)}));
 //BA.debugLineNum = 241;BA.debugLine="lblTimepassed.Gravity = Gravity.CENTER";
mostCurrent._lbltimepassed.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 242;BA.debugLine="lblTimepassed.Text = \"00:00:00\"";
mostCurrent._lbltimepassed.setText((Object)("00:00:00"));
 //BA.debugLineNum = 243;BA.debugLine="lblMoney.Gravity = Gravity.CENTER";
mostCurrent._lblmoney.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 244;BA.debugLine="lblRandom.Gravity = Gravity.CENTER";
mostCurrent._lblrandom.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 245;BA.debugLine="DateTime.SetTimeZone(0)";
anywheresoftware.b4a.keywords.Common.DateTime.SetTimeZone((int) (0));
 //BA.debugLineNum = 247;BA.debugLine="If StateManager.GetSetting(\"TotalTime\") = 0 OR StateManager.GetSetting(\"TotalTime\") = \"\" Then";
if ((mostCurrent._statemanager._getsetting(mostCurrent.activityBA,"TotalTime")).equals(BA.NumberToString(0)) || (mostCurrent._statemanager._getsetting(mostCurrent.activityBA,"TotalTime")).equals("")) { 
 //BA.debugLineNum = 248;BA.debugLine="strCurrency = \"$\"";
mostCurrent._strcurrency = "$";
 //BA.debugLineNum = 249;BA.debugLine="MoneyMade = 0";
_moneymade = (long) (0);
 }else {
 //BA.debugLineNum = 251;BA.debugLine="lblStartPause.Text = \"Press screen to pause\"";
mostCurrent._lblstartpause.setText((Object)("Press screen to pause"));
 //BA.debugLineNum = 252;BA.debugLine="TimeStart = StateManager.GetSetting2(\"TimeStart\", 0)";
_timestart = (long)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"TimeStart",BA.NumberToString(0))));
 //BA.debugLineNum = 253;BA.debugLine="dblSec = StateManager.GetSetting2(\"Sec\", 0)";
_dblsec = (double)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"Sec",BA.NumberToString(0))));
 //BA.debugLineNum = 254;BA.debugLine="dblWage = StateManager.GetSetting2(\"Wage\", 0)";
_dblwage = (double)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"Wage",BA.NumberToString(0))));
 //BA.debugLineNum = 255;BA.debugLine="TimeIdled = StateManager.GetSetting2(\"TimeIdled\", 0)";
_timeidled = (long)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"TimeIdled",BA.NumberToString(0))));
 //BA.debugLineNum = 256;BA.debugLine="Time1 = StateManager.GetSetting2(\"Time1\", 0)";
_time1 = (long)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"Time1",BA.NumberToString(0))));
 //BA.debugLineNum = 257;BA.debugLine="TotalTime = StateManager.GetSetting2(\"TotalTime\", 0)";
_totaltime = (long)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"TotalTime",BA.NumberToString(0))));
 //BA.debugLineNum = 258;BA.debugLine="MoneyMade = StateManager.GetSetting2(\"MoneyMade\", 0)";
_moneymade = (long)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"MoneyMade",BA.NumberToString(0))));
 //BA.debugLineNum = 259;BA.debugLine="dblTotalTip = StateManager.GetSetting2(\"TotalTip\", 0)";
_dbltotaltip = (double)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"TotalTip",BA.NumberToString(0))));
 //BA.debugLineNum = 261;BA.debugLine="If Time1 = 0 Then";
if (_time1==0) { 
 }else {
 //BA.debugLineNum = 264;BA.debugLine="Time2 = (DateTime.now/1000)";
_time2 = (long) ((anywheresoftware.b4a.keywords.Common.DateTime.getNow()/(double)1000));
 //BA.debugLineNum = 265;BA.debugLine="Timepassed = Time2 - Time1";
_timepassed = (long) (_time2-_time1);
 //BA.debugLineNum = 266;BA.debugLine="TimeIdled = TimeIdled + Timepassed";
_timeidled = (long) (_timeidled+_timepassed);
 //BA.debugLineNum = 267;BA.debugLine="StateManager.SetSetting(\"TimeIdled\", TimeIdled)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TimeIdled",BA.NumberToString(_timeidled));
 //BA.debugLineNum = 268;BA.debugLine="StateManager.SetSetting(\"Time1\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Time1",BA.NumberToString(0));
 };
 //BA.debugLineNum = 271;BA.debugLine="Timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 272;BA.debugLine="Timer2.Enabled = True";
_timer2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 273;BA.debugLine="RandomPick";
_randompick();
 };
 //BA.debugLineNum = 276;BA.debugLine="dblConvert = StateManager.GetSetting2(\"Conversion\", 0.84)";
_dblconvert = (double)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"Conversion",BA.NumberToString(0.84))));
 //BA.debugLineNum = 278;BA.debugLine="strCurrency = StateManager.GetSetting2(\"Currency\", \"$\")";
mostCurrent._strcurrency = mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"Currency","$");
 //BA.debugLineNum = 280;BA.debugLine="lblMoney.Text = strCurrency & MoneyMade";
...
int _result = 0;
 //BA.debugLineNum = 179;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean 'ignore";
 //BA.debugLineNum = 181;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 182;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 183;BA.debugLine="result = Msgbox2(\"Are you sure you want to quit the application?\", \"Warning\", \"Yes\", \"Cancel\", \"\", Null)";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 185;BA.debugLine="ExitApplication";
...
_dblsec = (_dblwage/(double)3600);
 ...
 //BA.debugLineNum = 346;BA.debugLine="lblWage.Text = \"Wage/h = \" & dblWage";
mostCurrent._lblwage.setText((Object)("Wage/h = "+BA.NumberToString(_dblwage)));
...
int _result = 0;
 //BA.debugLineNum = 121;BA.debugLine="Sub btnReset_down";
 //BA.debugLineNum = 123;BA.debugLine="Dim result As Int";
_result = 0;
 //BA.debugLineNum = 125;BA.debugLine="result = Msgbox2(\"Are you sure you want to reset your money made?\", \"Warning\", \"Yes\", \"Cancel\", \"\", Null)";
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 128;BA.debugLine="MoneyMade = 0";
_moneymade = (long) (0);
 //BA.debugLineNum = 129;BA.debugLine="TimePassedSinceStart = 0";
_timepassedsincestart = (long) (0);
 //BA.debugLineNum = 130;BA.debugLine="TimeIdled = 0";
_timeidled = (long) (0);
 //BA.debugLineNum = 131;BA.debugLine="TimeStart = 0";
_timestart = (long) (0);
 //BA.debugLineNum = 132;BA.debugLine="TotalTime = 0";
_totaltime = (long) (0);
 //BA.debugLineNum = 133;BA.debugLine="Time1 = 0";
_time1 = (long) (0);
 //BA.debugLineNum = 134;BA.debugLine="Time2 = 0";
_time2 = (long) (0);
 //BA.debugLineNum = 135;BA.debugLine="dblTotalTip = 0";
_dbltotaltip = 0;
 //BA.debugLineNum = 136;BA.debugLine="lblTimepassed.Text = \"00:00:00\"";
mostCurrent._lbltimepassed.setText((Object)("00:00:00"));
 //BA.debugLineNum = 137;BA.debugLine="lblRandom.Text = \"\"";
mostCurrent._lblrandom.setText((Object)(""));
 //BA.debugLineNum = 138;BA.debugLine="lblStartPause.Text = \"Press screen to start\"";
mostCurrent._lblstartpause.setText((Object)("Press screen to start"));
 //BA.debugLineNum = 139;BA.debugLine="StateManager.SetSetting(\"TotalTime\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TotalTime",BA.NumberToString(0));
 //BA.debugLineNum = 140;BA.debugLine="StateManager.SetSetting(\"MoneyMade\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"MoneyMade",BA.NumberToString(0));
 //BA.debugLineNum = 141;BA.debugLine="StateManager.SetSetting(\"TimeStart\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TimeStart",BA.NumberToString(0));
 //BA.debugLineNum = 142;BA.debugLine="StateManager.SetSetting(\"Sec\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Sec",BA.NumberToString(0));
 //BA.debugLineNum = 143;BA.debugLine="StateManager.SetSetting(\"Wage\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Wage",BA.NumberToString(0));
 //BA.debugLineNum = 144;BA.debugLine="StateManager.SetSetting(\"TimeIdled\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TimeIdled",BA.NumberToString(0));
 //BA.debugLineNum = 145;BA.debugLine="StateManager.SetSetting(\"Time1\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Time1",BA.NumberToString(0));
 //BA.debugLineNum = 146;BA.debugLine="StateManager.SetSetting(\"TotalTip\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TotalTip",BA.NumberToString(0));
 //BA.debugLineNum = 147;BA.debugLine="StateManager.SaveSettings";
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 //BA.debugLineNum = 148;BA.debugLine="lblMoney.Text = strCurrency & MoneyMade";
mostCurrent._lblmoney.setText((Object)(mostCurrent._strcurrency+BA.NumberToString(_moneymade)));
 //BA.debugLineNum = 149;BA.debugLine="Timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 150;BA.debugLine="Timer2.Enabled = False";
...
public static String  _btnsettings_down() throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Sub btnSettings_Down";
 //BA.debugLineNum = 77;BA.debugLine="StartActivity(PrefScreen.CreateIntent)";
...
public static String  _btnstart_down() throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Sub btnStart_Down";
 //BA.debugLineNum = 88;BA.debugLine="If Timer1.Enabled = False AND TimeStart = 0 Then";
if (_timer1.getEnabled()==anywheresoftware.b4a.keywords.Common.False && _timestart==0) { 
 //BA.debugLineNum = 89;BA.debugLine="TimeStart = (DateTime.now /1000)";
...
_timer2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 92;BA.debugLine="StateManager.SetSetting(\"TimeStart\", TimeStart)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TimeStart",BA.NumberToString(_timestart));
 //BA.debugLineNum = 93;BA.debugLine="StateManager.SetSetting(\"Wage\", dblWage)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Wage",BA.NumberToString(_dblwage));
 //BA.debugLineNum = 94;BA.debugLine="StateManager.SetSetting(\"Sec\", dblSec)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Sec",BA.NumberToString(_dblsec));
 //BA.debugLineNum = 95;BA.debugLine="lblStartPause.Text = \"Press screen to pause\"";
mostCurrent._lblstartpause.setText((Object)("Press screen to pause"));
 }else if(_timer1.getEnabled()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 97;BA.debugLine="Time2 = (DateTime.now/1000)";
_time2 = (long) ((anywheresoftware.b4a.keywords.Common.DateTime.getNow()/(double)1000));
 //BA.debugLineNum = 98;BA.debugLine="Time1 = StateManager.GetSetting2(\"Time1\", \"0\")";
_time1 = (long)(Double.parseDouble(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"Time1","0")));
 //BA.debugLineNum = 99;BA.debugLine="Timepassed = Time2 - Time1";
_timepassed = (long) (_time2-_time1);
 //BA.debugLineNum = 100;BA.debugLine="StateManager.SetSetting(\"Time1\", 0)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Time1",BA.NumberToString(0));
 //BA.debugLineNum = 101;BA.debugLine="TimeIdled = TimeIdled + Timepassed";
_timeidled = (long) (_timeidled+_timepassed);
 //BA.debugLineNum = 102;BA.debugLine="StateManager.SetSetting(\"TimeIdled\", TimeIdled)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TimeIdled",BA.NumberToString(_timeidled));
 //BA.debugLineNum = 103;BA.debugLine="Timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 104;BA.debugLine="Timer2.Enabled = True";
_timer2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 105;BA.debugLine="lblStartPause.Text = \"Press screen to pause\"";
mostCurrent._lblstartpause.setText((Object)("Press screen to pause"));
 }else {
...
_timer2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 109;BA.debugLine="Time1 = (DateTime.Now/1000)";
_time1 = (long) ((anywheresoftware.b4a.keywords.Common.DateTime.getNow()/(double)1000));
 //BA.debugLineNum = 110;BA.debugLine="StateManager.SetSetting(\"Time1\", Time1)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"Time1",BA.NumberToString(_time1));
 //BA.debugLineNum = 111;BA.debugLine="lblStartPause.Text = \"Press screen to start\"";
mostCurrent._lblstartpause.setText((Object)("Press screen to start"));
 //BA.debugLineNum = 112;BA.debugLine="StateManager.SaveSettings";
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 116;BA.debugLine="p.hidekeyboard(Activity)";
mostCurrent._p.HideKeyboard(mostCurrent._activity);
 //BA.debugLineNum = 118;BA.debugLine="End Sub";
return "";
}
public static String  _btntip_down() throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub btnTip_Down";
 //BA.debugLineNum = 160;BA.debugLine="ipdTip.Show(\"How much was the tip?\", \"Tip\", \"OK\", \"\", \"\", Null)";
mostCurrent._ipdtip.Show("How much was the tip?","Tip","OK","","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 162;BA.debugLine="If ipdTip.input = \"\" Then";
if ((mostCurrent._ipdtip.getInput()).equals("")) { 
 }else {
 //BA.debugLineNum = 164;BA.debugLine="dblTip = ipdTip.input";
_dbltip = (double)(Double.parseDouble(mostCurrent._ipdtip.getInput()));
 //BA.debugLineNum = 166;BA.debugLine="dblTotalTip = dblTotalTip + dblTip";
_dbltotaltip = _dbltotaltip+_dbltip;
 //BA.debugLineNum = 168;BA.debugLine="StateManager.SetSetting(\"TotalTip\", dblTotalTip)";
...
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 //BA.debugLineNum = 171;BA.debugLine="ipdTip.Input = \"\"";
mostCurrent._ipdtip.setInput("");
 };
 //BA.debugLineNum = 174;BA.debugLine="lblMoney.Text = strCurrency & NumberFormat((TotalTime*dblSec+dblTotalTip), 1, 2)";
mostCurrent._lblmoney.setText((Object)(mostCurrent._strcurrency+anywheresoftware.b4a.keywords.Common.NumberFormat((_totaltime*_dblsec+_dbltotaltip),(int) (1),(int) (2))));
...
_cat1.Initialize("Settings");
 //BA.debugLineNum = 291;BA.debugLine="cat1.AddEditText2(\"wage\", \"Hourly Wage\", \"\", \"10\", 12290, False, True, Null)";
_cat1.AddEditText2("wage","Hourly Wage","","10",(int) (12290),anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.True,BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 292;BA.debugLine="cat1.AddList(\"currency\", \"Currency\", \"\", \"$\", Null, listManCurr)";
_cat1.AddList("currency","Currency","","$",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null),mostCurrent._listmancurr);
 //BA.debugLineNum = 293;BA.debugLine="cat1.AddCheckBox(\"tips\", \"Enable tips\", \"\", \"\", False, Null)";
...
public static String  _timer1_tick() throws Exception{
 ...
 //BA.debugLineNum = 196;BA.debugLine="TimePassedSinceStart = (DateTime.Now/1000) - TimeStart";
_timepassedsincestart = (long) ((anywheresoftware.b4a.keywords.Common.DateTime.getNow()/(double)1000)-_timestart);
 //BA.debugLineNum = 197;BA.debugLine="TotalTime = TimePassedSinceStart - TimeIdled";
_totaltime = (long) (_timepassedsincestart-_timeidled);
 //BA.debugLineNum = 198;BA.debugLine="MoneyMade = NumberFormat((TotalTime*dblSec), 1, 2)";
_moneymade = (long)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat((_totaltime*_dblsec),(int) (1),(int) (2))));
 //BA.debugLineNum = 199;BA.debugLine="lblMoney.Text = strCurrency & NumberFormat((TotalTime*dblSec+dblTotalTip), 1, 2)";
mostCurrent._lblmoney.setText((Object)(mostCurrent._strcurrency+anywheresoftware.b4a.keywords.Common.NumberFormat((_totaltime*_dblsec+_dbltotaltip),(int) (1),(int) (2))));
 //BA.debugLineNum = 200;BA.debugLine="lblTimepassed.Text = DateTime.Time(TotalTime * 1000)";
mostCurrent._lbltimepassed.setText((Object)(anywheresoftware.b4a.keywords.Common.DateTime.Time((long) (_totaltime*1000))));
 //BA.debugLineNum = 202;BA.debugLine="StateManager.SetSetting(\"TotalTime\", TotalTime)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"TotalTime",BA.NumberToString(_totaltime));
 //BA.debugLineNum = 203;BA.debugLine="StateManager.SetSetting(\"MoneyMade\", MoneyMade)";
mostCurrent._statemanager._setsetting(mostCurrent.activityBA,"MoneyMade",BA.NumberToString(_moneymade));
 //BA.debugLineNum = 204;BA.debugLine="StateManager.SaveSettings";
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 //BA.debugLineNum = 206;BA.debugLine="End Sub";
return "";
}
public static String  _timer2_tick() throws Exception{
 //BA.debugLineNum = 209;BA.debugLine="Sub Timer2_Tick";
 //BA.debugLineNum = 211;BA.debugLine="RandomPick";
_randompick();
